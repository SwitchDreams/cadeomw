...
def parse_equivalence(course_id):
    ...
    request_data = get_cookies_for_parse(course_id)
...
def get_cookies_for_parse(subject_code):
    url = "https://sig.unb.br/sigaa/public/componentes/busca_componentes.jsf"
    ...
    payload = 'form=form&form%3Anivel=G&form%3Atipo=4&form%3Aunidades=0&form%3AbtnBuscarComponentes=Buscar%2BComponentes&javax.faces.ViewState=j_id1&form%3AcheckCodigo=on&form%3Aj_id_jsp_190531263_11={subject_code}&form%3Aj_id_jsp_190531263_13='
    header = {
        'Cookie': params["cookies"],
        'Content-Type': 'application/x-www-form-urlencoded'
    }
    page2 = requests.request("POST", url, headers=header, data=payload)
    page2_soup = BeautifulSoup(page2.text.encode('utf8'), 'html.parser')
    page2_soup.select('tbody td')
    return params
